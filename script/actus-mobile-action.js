if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
  ...
  var text = document.getElementById('s-actualites');
  text.href = "style/mobile-actualites.css";
  ...
  function checking() {
    ...
    if (x == "light") {
      ...
      var text = document.getElementById('s-actualites');
      text.href = "style/mobile-actualites-dark.css";
...
function verify() {
  ...
  var text = document.getElementById('s-actualites');
  text.href = "style/actualites.css"
  ...
  function checking() {
    ...
    if (x == "light") {
      ...
      var text = document.getElementById('s-actualites');
      text.href = "style/actualites-dark.css"
      document.getElementById('cro').checked = true;
    }
